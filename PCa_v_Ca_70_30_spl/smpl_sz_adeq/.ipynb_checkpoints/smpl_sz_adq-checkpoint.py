...
class LearningCurveAnalyzer:
    ...
    def plot_learning_curves(self, figsize=(12, 10), save_path=None):
        ...
        for idx, (model_name, result) in enumerate(self.results.items()):
            ...
            ax.set_title(f'Learning Curves of {model_name} for the \n Sample Size Adequacy Analysis', fontsize=16) #\nGap: {gap:.3f} | Val Improvement: {val_improvement:.3f}',
                        #fontsize=12, fontweight='bold')
            ax.legend(loc='lower right', frameon=True, shadow=False, fontsize=14)
